...
const MARISA_SIDE     := preload("res://Game/Entities/Player/PlayerResources/Marisa/ShotA/Shot/Side_Marisa.tscn")
...
func _ready():
	...
	%SideShot.set_levels(
		[side_01, side_02, side_03, side_04],
		{
			...
			3: {
				side_01: {
					"transform": Transform2D(deg_to_rad(-90), Vector2(25, 50)),
					"activated": true
				},
				side_02: {
					"transform": Transform2D(deg_to_rad(-90), Vector2(-25, 50)),
				...
				side_03: {
					"transform": Transform2D(deg_to_rad(-90), Vector2(75, 35)),
					"activated": true
				},
				side_04: {
					"transform": Transform2D(deg_to_rad(-90), Vector2(-75, 35)),
		...
		},
		{
			...
			2: {
				side_01: {
					"transform": Transform2D(deg_to_rad(-90), Vector2(20, -55)),
					"activated": true
				},
				side_02: {
					"transform": Transform2D(deg_to_rad(-90), Vector2(-20, -55)),
			...
			3: {
				...
				side_03: {
					"transform": Transform2D(deg_to_rad(-90), Vector2(60, -35)),
					"activated": true
				},
				side_04: {
					"transform": Transform2D(deg_to_rad(-90), Vector2(-60, -35)),
