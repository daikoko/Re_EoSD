...
const REIMU_NEEDLE   := preload("res://Game/Entities/Player/PlayerResources/Reimu/ShotB/Shot/Bullet_ReimuNeedle.tres")
...
func _ready():
	...
	side_01.visible = true
	var side_02 = REIMU_SIDE.instantiate()
	side_02.rotation = deg_to_rad(0)
	side_02.rotation_speed = deg_to_rad(60)
	side_02.visible = false
	var side_03 = REIMU_SIDE.instantiate()
	side_03.rotation = deg_to_rad(0)
	side_03.rotation_speed = deg_to_rad(60)
	side_03.visible = false
	var side_04 = REIMU_SIDE.instantiate()
	side_04.rotation = deg_to_rad(90)
	side_04.rotation_speed = deg_to_rad(-60)
	side_04.visible = true
	var side_05 = REIMU_SIDE.instantiate()
	side_05.rotation = deg_to_rad(90)
	side_05.rotation_speed = deg_to_rad(-60)
	side_05.visible = false
	var side_06 = REIMU_SIDE.instantiate()
	side_06.rotation = deg_to_rad(90)
	side_06.rotation_speed = deg_to_rad(-60)
	side_06.visible = false
	var side_07 = REIMU_SIDE.instantiate()
	side_07.rotation = deg_to_rad(180)
	side_07.rotation_speed = deg_to_rad(60)
	side_07.visible = true
	var side_08 = REIMU_SIDE.instantiate()
	side_08.rotation = deg_to_rad(180)
	side_08.rotation_speed = deg_to_rad(60)
	side_08.visible = false
	var side_09 = REIMU_SIDE.instantiate()
	side_09.rotation = deg_to_rad(180)
	side_09.rotation_speed = deg_to_rad(60)
	side_09.visible = false
	var side_10 = REIMU_SIDE.instantiate()
	side_10.rotation = deg_to_rad(270)
	side_10.rotation_speed = deg_to_rad(-60)
	side_10.visible = true
	var side_11 = REIMU_SIDE.instantiate()
	side_11.rotation = deg_to_rad(270)
	side_11.rotation_speed = deg_to_rad(-60)
	side_11.visible = false
	var side_12 = REIMU_SIDE.instantiate()
	side_12.rotation = deg_to_rad(270)
	side_12.rotation_speed = deg_to_rad(-60)
	side_12.visible = false
	
	%SideShot.set_levels(
		[
			side_01, side_02, side_03,
			side_04, side_05, side_06,
			side_07, side_08, side_09,
			side_10, side_11, side_12
		],
		{
			1: {
				side_01: {
					"transform": Transform2D(deg_to_rad(-90 + A_LEAN), Vector2.ZERO),
					"activated": false
				},
				side_02: {
					"transform": Transform2D(deg_to_rad(-90 + A_LEAN), Vector2.ZERO),
				...
				side_07: {
					"transform": Transform2D(deg_to_rad(-90 + B_LEAN), Vector2.ZERO),
					"activated": false
				},
				side_08: {
					"transform": Transform2D(deg_to_rad(-90 + B_LEAN), Vector2.ZERO),
			...
			2: {
				side_01: {
					"transform": Transform2D(deg_to_rad(-90 + A_LEAN - DISPLACEMENT), Vector2(20, 50)),
					"activated": true
				},
				side_02: {
					"transform": Transform2D(deg_to_rad(-90 + A_LEAN), Vector2(20, 50)),
					"activated": true
				},
				side_03: {
					"transform": Transform2D(deg_to_rad(-90 + A_LEAN + DISPLACEMENT), Vector2(20, 50)),
			...
			3: {
				...
				side_07: {
					"transform": Transform2D(deg_to_rad(-90 + B_LEAN - DISPLACEMENT), Vector2(55, 35)),
					"activated": true
				},
				side_08: {
					"transform": Transform2D(deg_to_rad(-90 + B_LEAN), Vector2(55, 35)),
					"activated": true
				},
				side_09: {
					"transform": Transform2D(deg_to_rad(-90 + B_LEAN + DISPLACEMENT), Vector2(55, 35)),
		...
		},
		{
			...
			2: {
				side_01: {
					"transform": Transform2D(deg_to_rad(-90 + A_LEAN - DISPLACEMENT_FOCUS), Vector2(15, -55)),
					"activated": true
				},
				side_02: {
					"transform": Transform2D(deg_to_rad(-90 + A_LEAN), Vector2(15, -55)),
					"activated": true
				},
				side_03: {
					"transform": Transform2D(deg_to_rad(-90 + A_LEAN + DISPLACEMENT_FOCUS), Vector2(15, -55)),
			...
			3: {
				...
				side_07: {
					"transform": Transform2D(deg_to_rad(-90 + B_LEAN - DISPLACEMENT_FOCUS), Vector2(45, -35)),
					"activated": true
				},
				side_08: {
					"transform": Transform2D(deg_to_rad(-90 + B_LEAN), Vector2(45, -35)),
					"activated": true
				},
				side_09: {
					"transform": Transform2D(deg_to_rad(-90 + B_LEAN + DISPLACEMENT_FOCUS), Vector2(45, -35)),
