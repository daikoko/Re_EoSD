...
const HELPER_19 := preload("res://Game/Entities/Boss/BossResources/Remilia/SpellResources/RemiliaHelper19.tscn")
...
@export var A_primary_spawners:int = 7
@export var A_secondary_spawners:int = 5
@export var A_fire_time:float = 0.6
const A_AFTER_ATTACK_WAIT := 3.6
...
func attack_a() -> void:
	...
	A_Shooter.fire(
		A_primary_spawners,
		A_secondary_spawners,
		A_fire_time,
		A_direction
	)
	
	await Boss.create_waiter(A_AFTER_ATTACK_WAIT).finished
