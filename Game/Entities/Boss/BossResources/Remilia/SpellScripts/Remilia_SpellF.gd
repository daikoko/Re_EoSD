...
const HELPER_09 := preload("res://Game/Entities/Boss/BossResources/Remilia/SpellResources/RemiliaHelper09.tscn")
...
const A_LINEAR_DELAY := 1.0
const A_LINEAR_TIME := 0.8
const A_LINEAR_SPEED := 120
const A_DELAY := 2.0
...
func attack_a():
	...
	await Boss.create_waiter(A_DELAY).finished
