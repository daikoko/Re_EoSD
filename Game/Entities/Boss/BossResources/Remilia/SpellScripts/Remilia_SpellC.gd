...
const HELPER_03 := preload("res://Game/Entities/Boss/BossResources/Remilia/SpellResources/RemiliaHelper03.tscn")
...
@export var A_primary_layout_spawner_count:int
@export var A_secondary_layout_spawner_count:int
@export var A_secondary_fire_count:int
const A_PRIMARY_LAYOUT_SHOT_RANGE := 120.0
const A_SECONDARY_SHOOTER_SPEED := 160.0
const A_SECONDARY_SHOOTER_ROTATION_SPEED := 60.0
const A_SECONDARY_FIRE_DURATION := 1.4
const A_SECONDARY_BULLET_SPEED := 180.0
const A_AFTER_ATTACK_WAIT := 2.0
...
func attack_a():
	...
	A_Shooter.fire(
		A_secondary_layout_spawner_count,
		A_SECONDARY_SHOOTER_SPEED,
		A_SECONDARY_SHOOTER_ROTATION_SPEED,
		A_secondary_fire_count,
		A_SECONDARY_FIRE_DURATION,
