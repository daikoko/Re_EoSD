...
const HELPER_12 := preload("res://Game/Entities/Boss/BossResources/Rumia/SpellResources/RumiaHelper12.tscn")
...
func prepare(EventHandler:Control, BossDict:Dictionary) -> float:
	...
	A_Shooter = HELPER_12.instantiate()
	A_Shooter.RNG = RNG
...
func attack_a():
	A_Shooter.fire()
	await A_Shooter.shooting_start
