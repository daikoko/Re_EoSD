...
const HELPER_19 := preload("res://Game/Entities/Boss/BossResources/Rumia/SpellResources/RumiaHelper19.tscn")
...
func start() -> void:
	...
	GlobalStage.change_player_default_position(Vector2(350, 390))
