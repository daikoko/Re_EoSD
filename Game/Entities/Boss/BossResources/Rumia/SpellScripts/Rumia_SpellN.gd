...
const HELPER_21 := preload("res://Game/Entities/Boss/BossResources/Rumia/SpellResources/RumiaHelper21.tscn")
...
func attack_a() -> void:
	...
	await Boss.create_waiter(1.4).finished
	
	Boss.position = GlobalStage.VIEWPORT_SIZE / 2
