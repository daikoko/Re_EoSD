...
var idle:String     = "_Idle"
var left:String     = "_Left"
var right:String    = "_Right"
var attack_a:String = "AttackA"
var attack_b:String = "AttackB"
...
func special_function(name:String="", _args:Array=[]):
	if name == "Alternate_Animation":
		set_alternate_animation()
...
func set_alternate_animation():
	idle     = "_SwordIdle"
	left     = "_SwordLeft"
	right    = "_SwordRight"
	attack_a = "_SwordAttackA"
	attack_b = "_SwordAttackB"
...
func play_invincibility_on():
	...
	%InvincibilitySprite.play("Invincibility")
