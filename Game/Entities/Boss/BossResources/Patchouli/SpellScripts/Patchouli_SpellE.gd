...
const HELPER_13 := preload("res://Game/Entities/Boss/BossResources/Patchouli/SpellResources/Helper13.tscn")
...
func attack_a() -> void:
	if A_phase == 0:
		A_Shooter.fire_orange(5)
		A_Shooter.fire_red(7)
		A_phase = 1
	elif A_phase == 1:
		A_Shooter.fire_orange(6)
		A_Shooter.fire_yellow(8)
		A_phase = 0
	await Boss.create_waiter(9).finished
