...
const HELPER_04 := preload("res://Game/Entities/Boss/BossResources/Patchouli/SpellResources/Helper04.tscn")
...
const DISTANCE     := 180
const TIME         := 0.6
const RAND_SEED    := 784452

var A_Shooter:Node2D
var A_bullets:Array[RowData]
@export_group("Shooter A")
@export var A_fire_time:float = 0.4
@export var A_spawn_amount:int = 24
