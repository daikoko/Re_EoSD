...
const HELPER_11 := preload("res://Game/Entities/Boss/BossResources/Patchouli/SpellResources/Helper11.tscn")
...
@export var A_fire_time:float = 0.8
@export var A_primary_layout_spawner_count:int = 3
@export var A_seconday_fire_count:int = 40
...
func prepare(EventHandler:Control, BossDict:Dictionary) -> float:
	...
	A_Shooter = HELPER_11.instantiate()
	A_Shooter.RNG = RNG
