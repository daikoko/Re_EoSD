...
const CIRNO_HELPER_01 := preload("res://Game/Entities/Boss/BossResources/Cirno/SpellResources/CirnoHelper01.tscn")
...
@export var A_layout_spawner_count:int = 10
@export var A_fire_time:float = 1.0
@export var A_spawn_stack_count:int = 3
const A_BULLET_SPEED := 180
const A_SPAWN_STACK_SPEED:int = 30
...
func prepare(EventHandler:Control, BossDict:Dictionary) -> float:
	...
	A_Shooter = CIRNO_HELPER_01.instantiate()
	A_Shooter.RNG = RNG
