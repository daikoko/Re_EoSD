...
const DIALOGUE_REIMU  := "ReimuStage03"
const DIALOGUE_MARISA := "MarisaStage03"
const DIALOGUE_RIN    := "RinStage03"

const BOSS_ID := GlobalSettings.BOSS.MEILING
const BOSS := preload("res://Game/Entities/Boss/BossScripts/Boss.tscn")
const SPRITE := preload("res://Game/Entities/Boss/BossResources/Meiling/Sprite/BossSprite_Meiling.tres")
const BACKGROUND := preload("res://Game/Entities/Boss/BossResources/Meiling/Background/Background_BossMeiling.tscn")

const BOSS_IN_POSITION := Vector2(780, -100)
const BOSS_THEME := preload("res://Game/Entities/Boss/BossResources/Meiling/Audio/Music_08.tres")
