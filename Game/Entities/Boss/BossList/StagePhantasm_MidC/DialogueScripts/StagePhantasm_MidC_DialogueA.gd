...
const DIALOGUE_REIMU  := "ReimuStagePhantasm_MidC"
const DIALOGUE_MARISA := "MarisaStagePhantasm_MidC"
const DIALOGUE_RIN    := "RinStagePhantasm_MidC"
...
func play_dialogue(EventHandler:Control, BossDict:Dictionary) -> void:
	...
	Boss.special_function("Alternate_Animation")
	Boss.hide()
	BossDict["boss"] = Boss
