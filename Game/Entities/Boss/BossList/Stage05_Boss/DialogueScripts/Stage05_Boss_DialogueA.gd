...
const DIALOGUE_REIMU  := "ReimuStage05"
const DIALOGUE_MARISA := "MarisaStage05"
const DIALOGUE_RIN    := "RinStage05"
...
const BOSS_THEME := preload("res://Game/Entities/Boss/BossResources/Sakuya/Audio/Music_12.tres")
