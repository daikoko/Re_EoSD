...
const DIALOGUE_REIMU  := "ReimuStage06"
const DIALOGUE_MARISA := "MarisaStage06"
const DIALOGUE_RIN    := "RinStage06"

const BOSS_ID := GlobalSettings.BOSS.REMILIA
const BOSS := preload("res://Game/Entities/Boss/BossScripts/Boss.tscn")
const SPRITE := preload("res://Game/Entities/Boss/BossResources/Remilia/Sprite/BossSprite_Remilia.tres")
const BACKGROUND := preload("res://Game/Entities/Boss/BossResources/Remilia/Background/Background_BossRemilia.tscn")

const BOSS_IN_POSITION := Vector2(780, -100)
const BOSS_THEME := preload("res://Game/Entities/Boss/BossResources/Remilia/Audio/Music_14.tres")
