...
const DIALOGUE_REIMU  := "ReimuStage04"
const DIALOGUE_MARISA := "MarisaStage04"
const DIALOGUE_RIN    := "RinStage04"

const BOSS_ID := GlobalSettings.BOSS.PATCHOULI
const BOSS := preload("res://Game/Entities/Boss/BossScripts/Boss.tscn")
const SPRITE := preload("res://Game/Entities/Boss/BossResources/Patchouli/Sprite/BossSprite_Patchouli.tres")
const BACKGROUND := preload("res://Game/Entities/Boss/BossResources/Patchouli/Background/Background_BossPatchouli.tscn")

const BOSS_IN_POSITION := Vector2(780, -100)
const BOSS_THEME := preload("res://Game/Entities/Boss/BossResources/Patchouli/Audio/Music_10.tres")
