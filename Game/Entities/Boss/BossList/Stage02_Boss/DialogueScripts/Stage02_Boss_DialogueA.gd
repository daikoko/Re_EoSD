...
const DIALOGUE_REIMU  := "ReimuStage02"
const DIALOGUE_MARISA := "MarisaStage02"
const DIALOGUE_RIN    := "RinStage02"

const BOSS_ID := GlobalSettings.BOSS.CIRNO
const BOSS := preload("res://Game/Entities/Boss/BossScripts/Boss.tscn")
const SPRITE := preload("res://Game/Entities/Boss/BossResources/Cirno/Sprite/BossSprite_Cirno.tres")
const BACKGROUND := preload("res://Game/Entities/Boss/BossResources/Cirno/Background/Background_BossCirno.tscn")

const BOSS_IN_POSITION := Vector2(780, -100)
const BOSS_THEME := preload("res://Game/Entities/Boss/BossResources/Cirno/Audio/Music_06.tres")
