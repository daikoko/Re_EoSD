...
const DIALOGUE_REIMU  := "ReimuStage01"
const DIALOGUE_MARISA := "MarisaStage01"
const DIALOGUE_RIN    := "RinStage01"
...
const BOSS_THEME := preload("res://Game/Entities/Boss/BossResources/Rumia/Audio/Music_04.tres")
