...
const DIALOGUE_REIMU  := "ReimuStagePhantasm"
const DIALOGUE_MARISA := "MarisaStagePhantasm"
const DIALOGUE_RIN    := "RinStagePhantasm"

const BOSS_ID := GlobalSettings.BOSS.RUMIA
const BOSS := preload("res://Game/Entities/Boss/BossScripts/Boss.tscn")
const SPRITE := preload("res://Game/Entities/Boss/BossResources/Rumia/Sprite/BossSprite_Rumia.tres")
const BACKGROUND := preload("res://Game/Entities/Boss/BossResources/Rumia/Background/Background_BossRumia.tscn")

const BOSS_IN_POSITION := Vector2(-100, -100)
const BOSS_THEME := preload("res://Game/Entities/Boss/BossResources/Rumia/Audio/Music_22.tres")
