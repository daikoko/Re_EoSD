...
const DIALOGUE_REIMU  := "ReimuStageExtra_MidB"
const DIALOGUE_MARISA := "MarisaStageExtra_MidB"
const DIALOGUE_RIN    := "RinStageExtra_MidB"

const BOSS_ID := GlobalSettings.BOSS.PATCHOULI
const BOSS := preload("res://Game/Entities/Boss/BossScripts/Boss.tscn")
const SPRITE := preload("res://Game/Entities/Boss/BossResources/Patchouli/Sprite/BossSprite_PatchouliExtra.tres")
