...
class_name EnemyShooter_Linear
...
@export_group("Linear")
@export var linear_delay:float = 0
@export var linear_time:float = 0
@export var linear_speed_change:float = 0
@export var linear_direction_change:float = 0
...
func set_shooter(enemy:Node2D) -> void:
	Main = GlobalShooter.create_linear_shooter(
