...
@export_group("Sine")
@export var sine_amplitude = 40
@export var sine_compression = 4
@export var sine_double:bool
@export var sine_double_bullets:Array[RowData_Column]
...
func set_shooter(enemy:Node2D) -> void:
	Main = GlobalShooter.create_sine_shooter(
...
func start() -> void:
	...
	while active:
		...
		Main.fire_round(
			...
			sine_double, sine_double_bullets,
			spawn_spawner_speed
		)
